...
$.DateTimePicker = $.DateTimePicker || {
	...
	defaults:  //Plugin Defaults
	{
		...
		shortMonthNames: ["Янв", "Фев", "Мар", "Апр", "Май", "Июнь", "Июл", "Авг", "Сен", "Окт", "Ноя", "Дек"],
		fullMonthNames: ["Январь", "Февраль", "Март", "Апрель", "Май", "Июн", "Июл", "Авг", "Сен", "Окт", "Ноябрь", "Декабрь"],
		...
		titleContentDateTime: "Введите Дату и Время",
